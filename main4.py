...
from joint2world4 import process_data
...
class App:
    def __init__(self, root):
        ...
        # 输入框2
        label2 = tk.Label(input_frame, text="Enter Axis num or Robot type:")
    ...
    def on_button_click(self):
        ...
        # 判断 axis_number
        if axis_number in [3,4,17]:
            process_data(file_path,axis_number)
        else:
    ...
    def update_history(self, file_name, axis_number):
        # 将当前输入添加到历史记录
        entry = f"{file_name}, Axis/Type: {axis_number}"
    ...
    def on_history_select(self, event):
        ...
        if selected_index:
            ...
            file_name, axis_number = selected_entry.split(", Axis/Type: ")
            self.entry1.delete(0, tk.END)
            self.entry1.insert(0, file_name)
