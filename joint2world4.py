...
def joint_to_world(joint,robot_type):
    if robot_type == 17:
        jtin = S225_joint_to_jtin(joint)
        t6 = S225_joint_to_world(jtin)
    else:
...
def process_data(file_path,robot_type):
    global offset
    ...
    for i in range(len(x)):
        ...
        result = joint_to_world(joint[i],robot_type)
